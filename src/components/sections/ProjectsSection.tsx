                ...
                <div className="rounded-3xl bg-slate-50 border-2 border-slate-200/80 p-4 sm:p-5 shadow-sm hover:shadow-2xl hover:border-[#13382f] transition-all duration-300 flex flex-col justify-between h-full">
                  ...
                  >
                    ...
                    <div className="relative z-10 flex justify-between items-start">
                      <span className="px-2.5 py-1 rounded-full bg-[#13382f] text-[#DFFF5E] text-[10px] font-extrabold uppercase tracking-wide shadow-xs">
                        0{idx + 1} Demo
                      </span>
                  ...
                  <div className="pt-3 px-1 border-t border-slate-200/80 flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      ...
                      <button
                        onClick={() => setActiveModalProject(project)}
                        className="px-3 py-1.5 rounded-xl bg-[#13382f] text-[#DFFF5E] hover:bg-black transition-colors font-bold text-xs uppercase tracking-wider flex items-center gap-1 cursor-pointer"
                      >
                        <span>Details</span>
