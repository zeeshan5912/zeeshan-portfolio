    ...
    <section id="projects" className="py-20 sm:py-32 bg-white text-[#13382f] relative">
      <Container size="default">
        ...
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto mb-10 sm:mb-16 px-2">
          <span className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-2 sm:mb-3">
            Portfolio Showcase
          </span>
            ...
            {CATEGORIES.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "px-4 sm:px-5 py-2 rounded-full text-xs font-bold transition-all duration-200 cursor-pointer uppercase tracking-wider whitespace-nowrap shrink-0",
                    isSelected
                      ? "bg-[#13382f] text-[#d4f938] shadow-md scale-105"
                ...
                <div className="rounded-3xl bg-slate-50 border-2 border-slate-200/80 p-4 sm:p-5 shadow-sm hover:shadow-2xl hover:border-[#13382f] transition-all duration-300 flex flex-col justify-between h-full">
                  ...
                  >
                    ...
                    <div className="relative z-10 flex justify-between items-start">
                      <span className="px-2.5 py-1 rounded-full bg-[#13382f] text-[#d4f938] text-[10px] font-extrabold uppercase tracking-wide shadow-xs">
                        0{idx + 1} Demo
                      </span>
                    ...
                    <div className="relative z-10">
                      <h3 className="text-xl font-extrabold tracking-tight text-white mb-1.5">
                        {project.title}
                      </h3>
                  ...
                  <div className="pt-3 px-1 border-t border-slate-200/80 flex items-center justify-between gap-2">
                    <div className="flex flex-wrap gap-1">
                      {project.technologies.slice(0, 3).map((t) => (
                        <span
                          key={t}
                          className="text-[10px] sm:text-[11px] font-semibold text-slate-700 bg-white px-2 py-0.5 rounded-md border border-slate-200"
                        >
                          {t}
                        </span>
                      ))}
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      {project.githubUrl && (
                        <a
                          ...
                          className="p-2 rounded-xl bg-white hover:bg-[#13382f] text-slate-700 hover:text-[#d4f938] border border-slate-200 transition-colors"
                      ...
                      <button
                        onClick={() => setActiveModalProject(project)}
                        className="px-3 py-1.5 rounded-xl bg-[#13382f] text-[#d4f938] hover:bg-black transition-colors font-bold text-xs uppercase tracking-wider flex items-center gap-1 cursor-pointer"
                      >
                        <span>Details</span>
