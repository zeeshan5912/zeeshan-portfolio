...
export function SkillsSection() {
  const coreFeatures = [
    { title: "React.js", desc: "Hooks & Modern SPA Architecture", icon: <Layers className="w-6 h-6 text-[#DFFF5E]" /> },
    { title: "Next.js (SSR)", desc: "Server Components & 100 SEO", icon: <Globe className="w-6 h-6 text-[#DFFF5E]" /> },
    { title: "JavaScript (ES6+)", desc: "Async/Await & Modern Syntax", icon: <Code2 className="w-6 h-6 text-[#DFFF5E]" /> },
    { title: "Redux State", desc: "Global Store & Hydration", icon: <Cpu className="w-6 h-6 text-[#DFFF5E]" /> },
    { title: "Tailwind CSS", desc: "Responsive & Modern Styling", icon: <Layout className="w-6 h-6 text-[#DFFF5E]" /> },
    { title: "Node.js & Express", desc: "Scalable REST APIs", icon: <Server className="w-6 h-6 text-[#DFFF5E]" /> },
    { title: "MongoDB Database", desc: "Mongoose & Data Models", icon: <Database className="w-6 h-6 text-[#DFFF5E]" /> },
    { title: "Mobile Responsive", desc: "100% Adaptive UI Layouts", icon: <Smartphone className="w-6 h-6 text-[#DFFF5E]" /> },
    { title: "Clean Architecture", desc: "Modular Reusable Code", icon: <ShieldCheck className="w-6 h-6 text-[#DFFF5E]" /> },
    { title: "Git & Versioning", desc: "Branching & Cloud Deploy", icon: <GitBranch className="w-6 h-6 text-[#DFFF5E]" /> },
  ];
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3.5 sm:gap-6">
          {coreFeatures.map((feat, idx) => (
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              className="p-4 sm:p-6 rounded-2xl sm:rounded-3xl bg-[#184439]/60 border border-emerald-700/50 hover:border-[#DFFF5E] hover:bg-[#184439] transition-all duration-300 flex flex-col items-center text-center group cursor-default shadow-sm hover:shadow-xl"
            >
