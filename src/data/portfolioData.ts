...
export const CERTIFICATIONS: CertificationItem[] = [
  {
    id: "simplilearn-react",
    title: "React.js Training Course",
    issuer: "Simplilearn",
    skills: ["React.js", "Hooks", "Component Lifecycle", "SPA Architecture"],
  ...
  },
  {
    ...
    issuer: "freeCodeCamp",
    skills: ["CSS3 Flexbox & Grid", "Media Queries", "Accessibility", "Modern Layouts"],
  ...
  },
  {
    ...
    skills: ["React Context API", "a11y Standards", "Reusable Component Architecture"],
    badgeColor: "border-blue-500/30 text-blue-400 bg-blue-950/30",
  },
  {
